...
import Shop from "@/app/Components/models/homeComponents/Shop/Shop" 
...
const Home = () => {
  return (
    <div className="">
      <div className="relative h-[calc(100vh-100px)]" style={{ backgroundImage: 'url("/images/byclebg.jpg")', backgroundRepeat:'no-repeat' , backgroundSize:'cover',backgroundAttachment:'fixed'}}>
